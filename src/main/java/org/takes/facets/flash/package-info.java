 ...
 * we're using Java logging levels for that, for example:</p>
 *
 * <pre>public final class TkDiscussion implements Take {
 *   &#64;Override
 *   public Response act(final Request req) {
 ...
 * }</pre>
 *
 * <p>This is how the HTTP response will look like (simplified):</p>
 *
 ...
 * but it's not recommended. It's better to use the default name.</p>
 *
 * <p>The next step is to understand that cookie on its way back,
 * from the browser to the server. This is what a browser will send back:</p>
 *
 * <pre> GET / HTTP/1.1
 ...
 * is to decorate your existing "take", for example:</p>
 *
 * <pre> new FtBasic(
 ...
 * (it's a pseudo-code, don't build HTML like this!):</p>
 *
 * <pre>public final class TkDiscussion implements Take {
 *   &#64;Override
 *   public Response act(final Request req) {
 ...
 * from cookies and adding them to XML:</p>
 *
 * <pre>public final class TkDiscussion implements Take {
