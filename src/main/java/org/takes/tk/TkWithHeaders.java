 ...
 * headers while preserving the original response content and status.</p>
 *
 ...
 * strings. Headers should follow the standard HTTP format: "Name: Value".</p>
 *
 * <p>Example usage:</p>
 * <pre>{@code
 ...
 * follow proper HTTP syntax and semantics.</p>
 *
