 ...
 * headers without the overhead of managing collections of headers.</p>
 *
 ...
 * or a single header string in the standard HTTP format "Name: Value".</p>
 *
 * <p>Example usage:</p>
 * <pre>{@code
 ...
 * using {@link TkWithHeaders} instead for better performance and cleaner code.</p>
 *
 ...
 * without modifying or removing existing headers from the wrapped take's response.</p>
 *
...
public final class TkWithHeader extends TkWrap {
    ...
    public TkWithHeader(final Take take, final String key, final String value) {
        this(take, new HeaderText(key, value));
    }
