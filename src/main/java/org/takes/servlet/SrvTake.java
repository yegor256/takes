...
public final class SrvTake extends HttpServlet {
     ...
     */
    private final AtomicReference<Take> take;
    ...
    public void init() throws ServletException {
        ...
        if (!this.take.compareAndSet(null, take)) {
    ...
    public void service(
        ...
        try {
            new ResponseOf(this.take.get().act(new RqFrom(req)))
                .applyTo(resp);
