 ...
 * @since 0.30
 */
public final class RsWithTypeHtml extends RsWrap {
     ...
     */
    public RsWithTypeHtml(final Response res) {
     ...
     */
    public RsWithTypeHtml(final Response res, final Charset charset) {
     ...
     *  present
     */
    RsWithTypeHtml(final Response res, final Opt<Charset> charset) {
        super(new LazyRs(res, "text/html", charset));
    }
}
